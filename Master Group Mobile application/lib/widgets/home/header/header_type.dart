...
class HeaderType extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<String> _rotate = [];
    double _fontSize = config['fontSize'] ?? 20;
      ...
      case 'typer':
        return SizedBox(
          ...
          child: TyperAnimatedTextKit(
            text: _rotate,
            textStyle: TextStyle(fontSize: _fontSize, fontFamily: "Bobbers"),
          ),
        );
      case 'typewriter':
        return SizedBox(
          ...
          child: TypewriterAnimatedTextKit(
            text: _rotate,
            textStyle: TextStyle(fontSize: _fontSize, fontFamily: "Agne"),
          ),
        );
      case 'scale':
        return SizedBox(
          ...
          child: ScaleAnimatedTextKit(
            text: _rotate,
            textStyle: TextStyle(fontSize: _fontSize, fontFamily: "Canterbury"),
          ),
        );
      case 'color':
        return SizedBox(
          ...
          child: ColorizeAnimatedTextKit(
            ...
            text: _rotate,
            textStyle: TextStyle(fontSize: _fontSize, fontFamily: "Horizon"),
            colors: [
              Colors.purple,
              Colors.blue,
              Colors.yellow,
