...
import 'package:fstore/widgets/home/banner/banner_items.dart';
import 'package:fstore/widgets/home/header/header_text.dart';
...
class _StateBannerSlider extends State<BannerSliderItems> {
  ...
  Widget build(BuildContext context) {
    final screenSize = MediaQuery.of(context).size;
    double _bannerPercent =
        widget.config['height'] ?? 0.5 / (screenSize.height / screenSize.width);
