      ...
      children: <Widget>[
        reviews == null
            ...
            : (reviews.length == 0
                ...
                : Column(
                    children: <Widget>[
                      for (var i = 0; i < reviews.length; i++) renderItem(context, reviews[i])
                    ],
                  )),
        SizedBox(
          height: 20,
            ...
            children: <Widget>[
              Expanded(
                child: TextField(
                  controller: comment,
                  maxLines: 3,
                  decoration: InputDecoration(labelText: S.of(context).writeComment),
                ),
              ),
              GestureDetector(
                child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Text(review.name, style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                SmoothStarRating(
                    allowHalfRating: true,
                    starCount: 5,
