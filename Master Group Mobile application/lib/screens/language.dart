        ...
        children: <Widget>[
          Card(
            ...
            child: ListTile(
              ...
              onTap: () {
                Provider.of<AppModel>(context).changeLanguage('en', context);
              },
            ),
          ),
          Divider(
          ...
          Card(
            ...
            child: ListTile(
              ...
              onTap: () {
                Provider.of<AppModel>(context).changeLanguage('vi', context);
              },
            ),
          ),
          Divider(
          ...
          Card(
            ...
            child: ListTile(
              ...
              onTap: () {
                Provider.of<AppModel>(context).changeLanguage('ar', context);
              },
            ),
          )
        ],
